package kz.edu.sdu.kab.divisor;
				...
				if(!indexList.isEmpty()) {
					...
					for(Integer i : indexList) {
						...
						// y is after consonant and before vowel
							...
							new Exception("kz.edu.sdu.kab.divisor.Divisor.yReplacementOutOfCaseException").printStackTrace();
						}
					}
				}
		...
		for(Word w : text.getWordList()) {
			...
			while (word.length() != 0) {
				...
				// ...0100.. then 010
					...
					Exception e = new Exception("kz.edu.sdu.kab.divisor.Divisor.SyllableOutOfCaseException");
					e.printStackTrace();
				}
